...
curl -L https://raw.githubusercontent.com/dusansimic/fp-build/main/fp-bundle.sh --create-dirs --output "/usr/local/bin/fp-bundle"
chmod u=rwx,g=rx,o=rx /usr/local/bin/jq /usr/local/bin/yq /usr/local/bin/fp-build /usr/local/bin/fp-bundle
